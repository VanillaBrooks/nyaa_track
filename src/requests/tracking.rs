...
// pub fn sync_request (urls : Vec<&str>, client: &request::Client , mut results_container: GetResults) -> GetResults {
...
// pub fn parse_html <'a>(html_vector: &Vec<String>, url_vector: &'a Vec<String>, prev_counts: UpdateFrequency) -> UpdateFrequency{
